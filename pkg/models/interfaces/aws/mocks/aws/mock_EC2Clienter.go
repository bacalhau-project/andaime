...
// GetIMDSConfig provides a mock function with no fields
func (_m *MockEC2Clienter) GetIMDSConfig() *imds.Client {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetIMDSConfig")
	}
...
// MockEC2Clienter_GetIMDSConfig_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetIMDSConfig'
type MockEC2Clienter_GetIMDSConfig_Call struct {
	*mock.Call
}

// GetIMDSConfig is a helper method to define mock.On call
func (_e *MockEC2Clienter_Expecter) GetIMDSConfig() *MockEC2Clienter_GetIMDSConfig_Call {
	return &MockEC2Clienter_GetIMDSConfig_Call{Call: _e.mock.On("GetIMDSConfig")}
}

func (_c *MockEC2Clienter_GetIMDSConfig_Call) Run(run func()) *MockEC2Clienter_GetIMDSConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockEC2Clienter_GetIMDSConfig_Call) Return(_a0 *imds.Client) *MockEC2Clienter_GetIMDSConfig_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEC2Clienter_GetIMDSConfig_Call) RunAndReturn(run func() *imds.Client) *MockEC2Clienter_GetIMDSConfig_Call {
	_c.Call.Return(run)
	return _c
}
