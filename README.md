...
Andaime (Poruguese for "scaffolding", prononced An-Dye-Me) is a command-line tool for managing AWS resources for the Bacalhau project. It allows you to create, list, and destroy AWS infrastructure components, including VPCs, subnets, internet gateways, route tables, security groups, and EC2 instances.
