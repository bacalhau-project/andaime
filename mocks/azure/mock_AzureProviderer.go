...
// GetAzureClient provides a mock function with given fields:
func (_m *MockAzureProviderer) GetAzureClient() azure.AzureClienter {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetAzureClient")
	}

	var r0 azure.AzureClienter
	if rf, ok := ret.Get(0).(func() azure.AzureClienter); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(azure.AzureClienter)
		}
	}
...
// MockAzureProviderer_GetAzureClient_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAzureClient'
type MockAzureProviderer_GetAzureClient_Call struct {
	*mock.Call
}

// GetAzureClient is a helper method to define mock.On call
func (_e *MockAzureProviderer_Expecter) GetAzureClient() *MockAzureProviderer_GetAzureClient_Call {
	return &MockAzureProviderer_GetAzureClient_Call{Call: _e.mock.On("GetAzureClient")}
}

func (_c *MockAzureProviderer_GetAzureClient_Call) Run(run func()) *MockAzureProviderer_GetAzureClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockAzureProviderer_GetAzureClient_Call) Return(_a0 azure.AzureClienter) *MockAzureProviderer_GetAzureClient_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAzureProviderer_GetAzureClient_Call) RunAndReturn(run func() azure.AzureClienter) *MockAzureProviderer_GetAzureClient_Call {
	_c.Call.Return(run)
	return _c
}
...
// SetAzureClient provides a mock function with given fields: client
func (_m *MockAzureProviderer) SetAzureClient(client azure.AzureClienter) {
	_m.Called(client)
}

// MockAzureProviderer_SetAzureClient_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetAzureClient'
type MockAzureProviderer_SetAzureClient_Call struct {
	*mock.Call
}

// SetAzureClient is a helper method to define mock.On call
//   - client azure.AzureClienter
func (_e *MockAzureProviderer_Expecter) SetAzureClient(client interface{}) *MockAzureProviderer_SetAzureClient_Call {
	return &MockAzureProviderer_SetAzureClient_Call{Call: _e.mock.On("SetAzureClient", client)}
}

func (_c *MockAzureProviderer_SetAzureClient_Call) Run(run func(client azure.AzureClienter)) *MockAzureProviderer_SetAzureClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(azure.AzureClienter))
	})
	return _c
}

func (_c *MockAzureProviderer_SetAzureClient_Call) Return() *MockAzureProviderer_SetAzureClient_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockAzureProviderer_SetAzureClient_Call) RunAndReturn(run func(azure.AzureClienter)) *MockAzureProviderer_SetAzureClient_Call {
	_c.Call.Return(run)
	return _c
}
