...
// GetPublicIPAddress provides a mock function with given fields: ctx, resourceGroupName, publicIPAddressName
func (_m *MockAzureClienter) GetPublicIPAddress(ctx context.Context, resourceGroupName string, publicIPAddressName string) (*armnetwork.PublicIPAddress, error) {
	ret := _m.Called(ctx, resourceGroupName, publicIPAddressName)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*armnetwork.PublicIPAddress, error)); ok {
		return rf(ctx, resourceGroupName, publicIPAddressName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *armnetwork.PublicIPAddress); ok {
		r0 = rf(ctx, resourceGroupName, publicIPAddressName)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string) error); ok {
		r1 = rf(ctx, resourceGroupName, publicIPAddressName)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockAzureClienter_Expecter) GetPublicIPAddress(ctx interface{}, resourceGroupName interface{}, publicIPAddressName interface{}) *MockAzureClienter_GetPublicIPAddress_Call {
	return &MockAzureClienter_GetPublicIPAddress_Call{Call: _e.mock.On("GetPublicIPAddress", ctx, resourceGroupName, publicIPAddressName)}
}

func (_c *MockAzureClienter_GetPublicIPAddress_Call) Run(run func(ctx context.Context, resourceGroupName string, publicIPAddressName string)) *MockAzureClienter_GetPublicIPAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *MockAzureClienter_GetPublicIPAddress_Call) Return(_a0 *armnetwork.PublicIPAddress, _a1 error) *MockAzureClienter_GetPublicIPAddress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAzureClienter_GetPublicIPAddress_Call) RunAndReturn(run func(context.Context, string, string) (*armnetwork.PublicIPAddress, error)) *MockAzureClienter_GetPublicIPAddress_Call {
	_c.Call.Return(run)
	return _c
}
