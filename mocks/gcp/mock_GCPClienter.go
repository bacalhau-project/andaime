...
// CreateServiceAccountKey provides a mock function with given fields: ctx, projectID, serviceAccountEmail
func (_m *MockGCPClienter) CreateServiceAccountKey(ctx context.Context, projectID string, serviceAccountEmail string) (*iam.ServiceAccountKey, error) {
	ret := _m.Called(ctx, projectID, serviceAccountEmail)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*iam.ServiceAccountKey, error)); ok {
		return rf(ctx, projectID, serviceAccountEmail)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *iam.ServiceAccountKey); ok {
		r0 = rf(ctx, projectID, serviceAccountEmail)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string) error); ok {
		r1 = rf(ctx, projectID, serviceAccountEmail)
	} else {
		r1 = ret.Error(1)
	}
...
// MockGCPClienter_CreateServiceAccountKey_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateServiceAccountKey'
type MockGCPClienter_CreateServiceAccountKey_Call struct {
	*mock.Call
}
...
func (_e *MockGCPClienter_Expecter) CreateServiceAccountKey(ctx interface{}, projectID interface{}, serviceAccountEmail interface{}) *MockGCPClienter_CreateServiceAccountKey_Call {
	return &MockGCPClienter_CreateServiceAccountKey_Call{Call: _e.mock.On("CreateServiceAccountKey", ctx, projectID, serviceAccountEmail)}
}

func (_c *MockGCPClienter_CreateServiceAccountKey_Call) Run(run func(ctx context.Context, projectID string, serviceAccountEmail string)) *MockGCPClienter_CreateServiceAccountKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *MockGCPClienter_CreateServiceAccountKey_Call) Return(_a0 *iam.ServiceAccountKey, _a1 error) *MockGCPClienter_CreateServiceAccountKey_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGCPClienter_CreateServiceAccountKey_Call) RunAndReturn(run func(context.Context, string, string) (*iam.ServiceAccountKey, error)) *MockGCPClienter_CreateServiceAccountKey_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockGCPClienter) EnsureProject(ctx context.Context, projectID string) (string, error) {
	ret := _m.Called(ctx, projectID)
...
//   - ctx context.Context
//   - projectID string
func (_e *MockGCPClienter_Expecter) EnsureProject(ctx interface{}, projectID interface{}) *MockGCPClienter_EnsureProject_Call {
	return &MockGCPClienter_EnsureProject_Call{Call: _e.mock.On("EnsureProject", ctx, projectID)}
}

func (_c *MockGCPClienter_EnsureProject_Call) Run(run func(ctx context.Context, projectID string)) *MockGCPClienter_EnsureProject_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockGCPClienter_EnsureProject_Call) RunAndReturn(run func(context.Context, string) (string, error)) *MockGCPClienter_EnsureProject_Call {
	_c.Call.Return(run)
	return _c
}
