...
func (_m *MockClusterDeployerer) ApplyBacalhauConfigs(ctx context.Context, sshConfig sshutils.SSHConfiger) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, sshutils.SSHConfiger) error); ok {
		r0 = rf(ctx, sshConfig)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockClusterDeployerer_Expecter) ApplyBacalhauConfigs(ctx interface{}, sshConfig interface{}) *MockClusterDeployerer_ApplyBacalhauConfigs_Call {
	return &MockClusterDeployerer_ApplyBacalhauConfigs_Call{Call: _e.mock.On("ApplyBacalhauConfigs", ctx, sshConfig)}
}
...
func (_c *MockClusterDeployerer_ApplyBacalhauConfigs_Call) Run(run func(ctx context.Context, sshConfig sshutils.SSHConfiger)) *MockClusterDeployerer_ApplyBacalhauConfigs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(sshutils.SSHConfiger))
	})
	return _c
}
...
// ProvisionAllMachinesWithPackages provides a mock function with given fields: ctx
func (_m *MockClusterDeployerer) ProvisionAllMachinesWithPackages(ctx context.Context) error {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for ProvisionAllMachinesWithPackages")
	}
...
// MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ProvisionAllMachinesWithPackages'
type MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call struct {
	*mock.Call
}

// ProvisionAllMachinesWithPackages is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockClusterDeployerer_Expecter) ProvisionAllMachinesWithPackages(ctx interface{}) *MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call {
	return &MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call{Call: _e.mock.On("ProvisionAllMachinesWithPackages", ctx)}
}

func (_c *MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call) Run(run func(ctx context.Context)) *MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call) Return(_a0 error) *MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call) RunAndReturn(run func(context.Context) error) *MockClusterDeployerer_ProvisionAllMachinesWithPackages_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClusterDeployerer) ProvisionPackagesOnMachine(ctx context.Context, machineName string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ProvisionPackagesOnMachine")
	}
...
func (_e *MockClusterDeployerer_Expecter) ProvisionPackagesOnMachine(ctx interface{}, machineName interface{}) *MockClusterDeployerer_ProvisionPackagesOnMachine_Call {
	return &MockClusterDeployerer_ProvisionPackagesOnMachine_Call{Call: _e.mock.On("ProvisionPackagesOnMachine", ctx, machineName)}
}
