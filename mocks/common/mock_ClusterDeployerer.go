...
func (_m *MockClusterDeployerer) SetSSHClient(client sshutils.SSHClienter) {
	_m.Called(client)
}

// MockClusterDeployerer_SetSSHClient_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetSSHClient'
type MockClusterDeployerer_SetSSHClient_Call struct {
	*mock.Call
}

// SetSSHClient is a helper method to define mock.On call
//   - client sshutils.SSHClienter
func (_e *MockClusterDeployerer_Expecter) SetSSHClient(client interface{}) *MockClusterDeployerer_SetSSHClient_Call {
	return &MockClusterDeployerer_SetSSHClient_Call{Call: _e.mock.On("SetSSHClient", client)}
}

func (_c *MockClusterDeployerer_SetSSHClient_Call) Run(run func(client sshutils.SSHClienter)) *MockClusterDeployerer_SetSSHClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClusterDeployerer_SetSSHClient_Call) Return() *MockClusterDeployerer_SetSSHClient_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockClusterDeployerer_SetSSHClient_Call) RunAndReturn(run func(sshutils.SSHClienter)) *MockClusterDeployerer_SetSSHClient_Call {
	_c.Run(run)
	return _c
}
